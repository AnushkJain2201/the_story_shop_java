            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="profile.do"
                        ...
                        <span class="ms-3">Your Profile</span>
                    </a>
                </li>
                <li>
                    <a href="show_cart.do"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Your Cart</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">${cartbookids.size()}</span>
                    </a>
                ...
                <li>
                    <a href="get_wishlists.do"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Your Wishlists</span>
                    </a>
                </li>
                <!-- <li>
                    <a href="#"
