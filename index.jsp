    ...
    <main class="bg-gray-900 md:px-24 px-8">
      <div class="md:h-[580px] h-[620px] bg-gradient-to-b from-gray-900 to-gray-700 mb-24 rounded-b-[50px] relative">
        ...
        <div class="absolute md:top-[240px] md:left-[450px] top-[382px] left-12 md:block hidden">
          <img src="static/media/images/landing/Book_log_2.png" class="md:h-[450px] h-[225px]" alt="bookshop" />
        </div>
      </div>
      ...
      <div class="md:mb-8 flex md:flex-row flex-col-reverse md:justify-around justify-between items-center">
        ...
        <div class="md:mb-0 mb-5">
          <img src="static/media/images/landing/Bookshop.gif" class="md:w-96 w-48 rounded-3xl" alt="bookshop" />
        </div>
      </div>
