        ...
        <section class="py-8 antialiased bg-gray-900 md:py-16">
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                <div class="mx-auto max-w-5xl">
                    ...
                    <c:forEach var="premium" items="${premiums}">
                        <c:if test="${premium.premiumId==premiums_id}">
                            <h2 class="text-xl font-semibold text-white sm:text-2xl">Payment
                                <c:out value=" (${premium.name})" />
                            </h2>

                            <h2 class="text-md font-semibold text-white sm:text-lg">
                                <c:out value="${premium.description}" />
                            </h2>

                        </c:if>
                    </c:forEach>
                    <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
                        <form action="payment_premiums.do" method="post"
                            ...
                            <c:forEach var="premium" items="${premiums}">
                                <c:if test="${premium.premiumId==premiums_id}">
                                    ...
                                    <input hidden type="text" name="premium_id_in" value="${premium.premiumId}">
                                    <input hidden type="text" name="premium_name_in" value="${premium.name}">
                                </c:if>
                            </c:forEach>
                            ...
                            <button
                                class="text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Pay
                                Now</button>
                        </form>
                            ...
                            <div
                                ...
                                <div class="space-y-2">
                                    ...
                                    <dl class="flex items-center justify-between gap-4">
                                        ...
                                        <dd class="text-base font-medium text-gray-900 dark:text-white">&#x20B9;50.00
                                        </dd>
                                    </dl>

                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Tax</dt>
                                        <dd class="text-base font-medium text-gray-900 dark:text-white">&#x20B9;18.00
                                        </dd>
                                    </dl>
                                </div>
                                ...
                                <dl
                                    ...
                                    <c:choose>
                                        <c:when test="${premiums_id == 1}">
                                            <dd class="text-base font-bold text-gray-900 dark:text-white">&#x20B9;467.00
                                            </dd>
                                        </c:when>
                                        <c:when test="${premiums_id == 2}">
                                            <dd class="text-base font-bold text-gray-900 dark:text-white">&#x20B9;567.00
                                            </dd>
                                        </c:when>
                                        <c:when test="${premiums_id == 3}">
                                            <dd class="text-base font-bold text-gray-900 dark:text-white">&#x20B9;767.00
                                            </dd>
                                        </c:when>
                                    </c:choose>
                                </dl>
