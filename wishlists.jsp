...
<body class="bg-gray-900">
    ...
    <div class="border-gray-700 border m-2 rounded-lg p-4">
        <h1
            class="text-5xl font-semibold mb-8 font-sans text-white capitalize text-center text-wrap md:text-nowrap">Wishlists</h1>
        <div
                ...
                <div
                    ...
                    <a href="#">
                        <img class="p-8 rounded-t-lg w-full h-[60%]"
                            src="show_explore_book_img.do?path=${wishlist.book.bookImg}&email=${wishlist.book.user.email}"
                            alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        ...
                        <div class="flex w-[100%] justify-center gap-4  items-center mt-2.5 mb-5">
                            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                <c:if test="${user != null}">
                                    <c:choose>
                                        <c:when test="${a:isLiked(wishlist.book.bookId, user.userId)}">
                                            <form action="remove_a_wishlist.do" method="POST">
                                                <input type="hidden" name="book-id"
                                                    value="${wishlist.book.bookId}" />
                                                <input type="hidden" name="user-id" value="${user.userId}" />
                                                <input type="hidden" name="likes" value="${wishlist.book.likes}" />
                            ...
                            <span
                                ...
                                <c:out value="${wishlist.book.likes}" />
                            </span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-3xl font-bold text-gray-900 dark:text-white">&#8377;
                                <c:out value="${wishlist.book.price}" />
                            </span>
                            <a href="#"
