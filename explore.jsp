            ...
            <div
                ...
                <c:forEach var="rentalBook" items="${rentalbooks}">
                    <div
                        ...
                        <a href="#">
                            <img class="p-8 rounded-t-lg w-full h-[60%]" src="show_explore_book_img.do?path=${rentalBook.bookImg}&email=${rentalBook.user.email}"
                                alt="product image" />
                        </a>
                        <div class="px-5 pb-5">
                            ...
                            <h1 class="text-xl md:text-2xl text-center italic font-light text-gray-900 capitalize dark:text-white">
                                <c:out value="${rentalBook.author}" />
                            </h1>

                            <div class="w-full max-h-[80px] text-center overflow-y-scroll text-wrap text-sm text-white my-3">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-3xl font-bold text-gray-900 dark:text-white">&#8377;<c:out value="${rentalBook.price}" /></span>
                                <a href="#"
            ...
            <div
                ...
                <c:forEach var="saleBook" items="${salebooks}">
                    <div
                        class="w-full h-[700px] max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="p-8 rounded-t-lg w-full h-[60%]" src="show_explore_book_img.do?path=${saleBook.bookImg}&email=${saleBook.user.email}"
                                alt="product image" />
                        </a>
                        <div class="px-5 pb-5">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-3xl font-bold text-gray-900 dark:text-white">&#8377;<c:out value="${saleBook.price}" /></span>
                                <a href="#"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add
                                    to cart</a>
                            </div>
